% https://la.mathworks.com/matlabcentral/fileexchange/69063-matlab-table-to-latex-conversor
% ----------------------------------------------------------------------- %
...
function table2latex(T, filename)
    ...
    n_col = size(T,2);
    col_spec = [];
    for c = 1:n_col, col_spec = [col_spec 'c']; end % Lo modifiqué para c en vez de l
