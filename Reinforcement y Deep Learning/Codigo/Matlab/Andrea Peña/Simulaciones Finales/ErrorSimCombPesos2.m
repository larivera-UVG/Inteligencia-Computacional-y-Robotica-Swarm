...
% FORMACIÓN, EVASIÓN DE OBSTÁCULOS Y MANTENIMIENTO DE LA CONECTIVIDAD
% =========================================================================
...
for I = 1:cantI
    ...
    %         V(:,1) = 0;          % líder inmóvil
        ...
        % Almacenamiento de variables para análisis
    ...
    if(errorF > 0.05)   
        ...
        [errorR,cantAS] = ErrorIndividual(mDistF, Fmatrix(2,8), 15);
    else
