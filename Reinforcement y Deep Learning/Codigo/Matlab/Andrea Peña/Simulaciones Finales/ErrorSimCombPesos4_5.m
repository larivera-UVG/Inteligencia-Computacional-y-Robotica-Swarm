% =========================================================================
% MEDICIÓN DE MÉTRICAS EN LA SIMULACIÓN DE MODELO DINÁMICO CON CONTROL DE 
% FORMACIÓN Y EVASIÓN DE OBSTÁCULOS
% =========================================================================
% Autor: Andrea Maybell Peña Echeverría
% Última modificación: 10/08/2019
% (Métricas MODELO 4)
% =========================================================================
% El siguiente script implementa la simulación del modelo dinámico de
% modificación a la ecuación de consenso utilizando control de formación y
% luego una combinación de control de formación con evasión de obstáculos
% cierto número de veces para determinar las métricas de error y cálculos 
% de energía.
% =========================================================================
...
for I = 1:cantI
    ...
    while(t < T)
            ...
            for j = 1:N
                ...
                if(mdist == 0 || mdist >= R)
                    ...
                    switch cambio
                        ...
                        case {1,2}      % collision avoidance & formation control
                            w = (4*(mdist - dij)*(mdist - r) - 2*(mdist - dij)^2)/(mdist^3);    
                    end
                end
        ...
        % Al llegar muy cerca de la posición deseada
        if(norm(V) < 0.2)
            cambio = cambio + 1;
        end
