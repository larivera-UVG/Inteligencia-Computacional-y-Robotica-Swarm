...
// Fitness Function (0 - Sphere, 1 - Rosenbrock, 2 - Booth, 3 - Himmelblau)
...
int main() {
  ...
  if (strcmp(wb_robot_get_name(), "e-puck") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck0.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(1)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck1.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(2)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck2.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(3)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck3.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(4)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck4.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(5)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck5.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(6)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck6.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(7)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck7.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(8)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck8.txt", "w");
  } else if (strcmp(wb_robot_get_name(), "e-puck(9)") == 0){
   fp = fopen("C:\\Users\\My User\\Documents\\Trabajos UVG\\9no. Semestre\\Megaproyecto\\SimulacionPSO\\epuck9.txt", "w");
  } else {
   fp = 0;
