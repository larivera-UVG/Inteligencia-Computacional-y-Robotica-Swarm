...
#define CONSTRICTION_FACTOR 0.5
#define COGNITIVE_WEIGTH 400
#define SOCIAL_WEIGTH 50
#define TIME_DELTA 1

#define DIVERSITY_FACTOR 30
...
// Funcion para hallar la distancia minima hacia 1 obstaculo
...
double min_distance3(double x1, double y1){
  ...
  if (x1 > xcoord1){
    if (y1 > ycoord1){
      min4 = euclidean_distance(x1,y1,xcoord1,ycoord1);
    }
    else{
      min4 = euclidean_distance(x1,y1,xcoord1,ycoord2);
    } 
  }
  else{
    if (y1 > ycoord1){
      min4 = euclidean_distance(x1,y1,xcoord2,ycoord1);
    }
    else{
      min4 = euclidean_distance(x1,y1,xcoord2,ycoord2);
    } 
  }
  ...
  if (x1 > xcoord1){
    if (y1 > ycoord1){
      min5 = euclidean_distance(x1,y1,xcoord1,ycoord1);
    }
    else{
      min5 = euclidean_distance(x1,y1,xcoord1,ycoord2);
    } 
  }
  else{
    if (y1 > ycoord1){
      min5 = euclidean_distance(x1,y1,xcoord2,ycoord1);
    }
    else{
      min5 = euclidean_distance(x1,y1,xcoord2,ycoord2);
    } 
  }
  ...
  if (x1 > xcoord1){
    if (y1 > ycoord1){
      min6 = euclidean_distance(x1,y1,xcoord1,ycoord1);
    }
    else{
      min6 = euclidean_distance(x1,y1,xcoord1,ycoord2);
    } 
  }
  else{
    if (y1 > ycoord1){
      min6 = euclidean_distance(x1,y1,xcoord2,ycoord1);
    }
    else{
      min6 = euclidean_distance(x1,y1,xcoord2,ycoord2);
    } 
  }
...
double fitness(double x, double y){
  ...
  if (BENCHMARK_TYPE == 0){
    ...
    eta = 2;
    zeta = 10;
    dist2goal = euclidean_distance(x,y,0.0865,0.853);
    if (dist2goal <= dstar){
