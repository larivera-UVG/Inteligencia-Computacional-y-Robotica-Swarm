...
4. Click Next, seleccionar C y seleccionar Webots como IDE, nombrar controlador "epuck_swarm"
5. Ya creado el controlador, en la pantalla derecha de Webots se abre un script .c vacío.
   Copiar el código del archivo epuck_swarm.c a este archivo.
...
NOTA IMPORTANTE: El archivo epuck_swarm.c crea archivos de texto que almacenan resultados
